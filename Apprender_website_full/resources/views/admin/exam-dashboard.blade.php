    ...
    <table class="table">
        ...
        <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-info editButton" data-id="{{ $exam->id }}" data-disabled="" data-toggle="modal" data-target="#editExamModal">Edit</button>
                        </td>
                        <td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
          ...
          @csrf
              <div class="modal-body">
                  ...
                  <br><br>
                        <input type="time" name="time" placeholder="mins" pattern="^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$" class="w-100" required>
                  <br><br>
                  <input type="number" min="1" name="attempt" placeholder="Enter Exam Attempt Time" class="w-100" required>
                  <br><br>
                  <br><br>
